...
- [aada](https://github.com/openclaw/skills/tree/main/skills/rylena/aada/SKILL.md) - 从一个代理向 Moltbook 受众创建并发送有趣、富有个性的推广消息。
...
- [acorn-prover](https://github.com/openclaw/skills/tree/main/skills/flyingnobita/acorn-prover/SKILL.md) - 使用 Acorn 定理证明器进行数学和密码学形式化的验证与证明编写。
...
- [age-transformation](https://github.com/openclaw/skills/tree/main/skills/eftalyurtseven/age-transformation/SKILL.md) - 使用 each::sense AI 跨年龄段转换人脸。
...
- [agents-skill-podcastifier](https://github.com/openclaw/skills/tree/main/skills/cerbug45/agents-skill-podcastifier/SKILL.md) - 将传入文本（电子邮件/新闻通讯）转换为简短的 TTS 播客，支持分块和 ffmpeg 拼接。
...
- [ai-persona-engine](https://github.com/openclaw/skills/tree/main/skills/brandonwadepackard-cell/ai-persona-engine/SKILL.md) - 构建情感智能的 AI 人设，用于语音和聊天角色扮演，使用演员指导提示。
...
- [canvs](https://github.com/openclaw/skills/tree/main/skills/voronkovm/canvs/SKILL.md) - 使用 Canvs.io 工具创建和操作协作文档白板和图表。
- [captions](https://github.com/openclaw/skills/tree/main/skills/therohitdas/captions/SKILL.md) - 从 YouTube 视频提取隐藏字幕和字幕。
- [catalog](https://github.com/openclaw/skills/tree/main/skills/rodbalbino/catalog/SKILL.md) - 工作室简单目录（hello world）
- [cavas-skill](https://github.com/openclaw/skills/tree/main/skills/ttboy/cavas-skill/SKILL.md) - 使用设计哲学在 .png 和 .pdf 文档中创建精美视觉艺术。
...
- [clinkding](https://github.com/openclaw/skills/tree/main/skills/daveonkels/clinkding/SKILL.md) - 管理 linkding 书签 - 保存 URL、搜索、标记、整理。
- [color-palette](https://github.com/openclaw/skills/tree/main/skills/qrost/color-palette/SKILL.md) - 从图像提取颜色调色板，返回 HEX/RGB 值，可选附带色卡图像。
...
- [didit-passive-liveness](https://github.com/openclaw/skills/tree/main/skills/rosasalberto/didit-passive-liveness/SKILL.md) - 集成 Didit 被动活体检测独立 API，验证用户是否实际在场。
...
- [eachlabs-video-edit](https://github.com/openclaw/skills/tree/main/skills/eftalyurtseven/eachlabs-video-edit/SKILL.md) - 编辑视频，支持唇形同步、翻译、字幕。
...
- [fal-text-to-image](https://github.com/openclaw/skills/tree/main/skills/delorenj/fal-text-to-image/SKILL.md) - 使用 fal.ai 的 AI 生成、混剪和编辑图像。
...
- [generate-news-article](https://github.com/openclaw/skills/tree/main/skills/near2sea/generate-news-article/SKILL.md) - 从 SerpAPI Google 搜索结果生成独立的 Markdown 文章，附带图像。
...
- [instagram-reels](https://github.com/openclaw/skills/tree/main/skills/antoinedc/instagram-reels/SKILL.md) - 下载 Instagram Reels，转录音频，提取字幕。
- [install-then-update-trap-detector](https://github.com/openclaw/skills/tree/main/skills/andyxinweiminicloud/install-then-update-trap-detector/SKILL.md) - 帮助检测"先安装后更新"攻击模式 — 即技能通过初始安全审查后干净地执行。
- [kai-tw-figma](https://github.com/openclaw/skills/tree/main/skills/kai-tw/kai-tw-figma/SKILL.md) - 与 Figma REST API 交互，读取文件、导出图层/组件为图像，检索评论。
- [kie-ai-skill](https://github.com/openclaw/skills/tree/main/skills/jon-xo/kie-ai-skill/SKILL.md) - 通过 kie.ai 统一 API 访问多个 AI 模型 - 图像生成（Nano Banana Pro、Flux、4o-image）优惠 30-80%。
- [kraken-pro](https://github.com/openclaw/skills/tree/main/skills/in-liberty420/kraken-pro/SKILL.md) - 管理 Kraken 交易所账户 — 投资组合、市场数据、交易、收益/质押、分类账导出。
- [macos-local-voice](https://github.com/openclaw/skills/tree/main/skills/strrl/macos-local-voice/SKILL.md) - 使用 macOS 原生 Apple 功能进行本地 STT 和 TTS。
- [mamo](https://github.com/openclaw/skills/tree/main/skills/anajuliabit/mamo/SKILL.md) - 在 Base（Moonwell）上与 Mamo DeFi 收益策略交互
- [media-writing](https://github.com/openclaw/skills/tree/main/skills/alvinecarn/media-writing/SKILL.md) - 你是一位专业的媒体写作专家，在创建引人入胜和富有影响力的内容方面拥有丰富经验。
...
- [minara](https://github.com/openclaw/skills/tree/main/skills/lowesyang/minara/SKILL.md) - 加密交易：兑换、永续合约、转账、支付、存款（信用卡/加密）、提款、AI 聊天、市场发现。
- [mindmap-generator](https://github.com/openclaw/skills/tree/main/skills/parasharnagle/mindmap-generator/SKILL.md) - 从对话、目标、决策和日常优先级生成视觉思维导图图像 — 以 PNG 格式交付。
- [mixtiles-it](https://github.com/openclaw/skills/tree/main/skills/saharcarmel/mixtiles-it/SKILL.md) - 发送照片到 Mixtiles 订购墙面瓷砖。
- [moonfunsdk](https://github.com/openclaw/skills/tree/main/skills/moonnfunofficial/moonfunsdk/SKILL.md) - 专业 Python SDK，用于在币安智能链上创建和交易 Meme 代币，支持 AI 驱动的图像生成。
...
- [opencr-skill](https://github.com/openclaw/skills/tree/main/skills/topdu/opencr-skill/SKILL.md) - 使用 OpenOCR 从图像、文档和扫描 PDF 提取文本 - 支持文本检测、识别。
- [opengfx](https://github.com/openclaw/skills/tree/main/skills/aklo360/opengfx/SKILL.md) - AI 品牌设计系统 — 标志系统、品牌吉祥物、社交资产和符合品牌的营销图形，通过 ACP 或 x402。
- [openindex](https://github.com/openclaw/skills/tree/main/skills/titocosta/openindex/SKILL.md) - 为 AI 代理提供端到端加密消息传递。
- [openocr-skill](https://github.com/openclaw/skills/tree/main/skills/topdu/openocr-skill/SKILL.md) - 使用 OpenOCR 从图像、文档和扫描 PDF 提取文本。
- [options-spread-conviction-engine](https://github.com/openclaw/skills/tree/main/skills/adamnaghs/options-spread-conviction-engine/SKILL.md) - 多制度期权价差分析引擎，具有定量严谨性。
...
- [paythefly](https://github.com/openclaw/skills/tree/main/skills/seanlan/paythefly/SKILL.md) - 为你的应用创建加密支付和提款链接。
...
- [popup-organizer](https://github.com/openclaw/skills/tree/main/skills/eliaskress/popup-organizer/SKILL.md) - 在 PopUp 上搜索和雇佣活动移动供应商。
...
- [rent-a-person-ai](https://github.com/openclaw/skills/tree/main/skills/saireetikap/rent-a-person-ai/SKILL.md) - > 雇佣人类完成 AI 无法做的现实世界任务：配送、会议、差事、摄影、宠物护理。
...
- [rug-checker](https://github.com/openclaw/skills/tree/main/skills/tkuehnl/rug-checker/SKILL.md) - Solana 代币拉地毯风险分析。10 点链上检查附带可视化报告。
...
- [solo-humanize](https://github.com/openclaw/skills/tree/main/skills/fortunto2/solo-humanize/SKILL.md) - 从文本中去除 AI 写作模式 — 破折号、固定短语、推广夸大、表演性真实。
...
- [superpower](https://github.com/openclaw/skills/tree/main/skills/grx21/superpower/SKILL.md) - **使用时机：** 用户有任务想要完成或想让你完成，或者他们感到沮丧、不安、压力。
...
- [telegram-media](https://github.com/openclaw/skills/tree/main/skills/ryandeangraves/telegram-media/SKILL.md) - **你必须使用 shell/exec 工具实际执行每个命令。** 切勿假装你发送了照片、语音笔记。
- [telegram-voice-to-voice-macos](https://github.com/openclaw/skills/tree/main/skills/fiberian1981/telegram-voice-to-voice-macos/SKILL.md) - 适用于 macOS Apple Silicon 的 Telegram 语音转语音：使用 yap（Speech.framework）转录传入的 .ogg 语音笔记
...
- [x-founder-operations](https://github.com/openclaw/skills/tree/main/skills/linfangw/x-founder-operations/SKILL.md) - 为创始人、独立开发者和技术专业人士提供的系统化 X（Twitter）运营技能。
...
- [youtube-thumbnail-generation](https://github.com/openclaw/skills/tree/main/skills/eftalyurtseven/youtube-thumbnail-generation/SKILL.md) - 使用 each::sense API 生成高点击率设计的吸引眼球的 YouTube 缩略图。
