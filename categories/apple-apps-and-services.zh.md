...
- [apple-health-skill](https://github.com/openclaw/skills/tree/main/skills/nftechie/apple-health-skill/SKILL.md) - 与您的 Apple Health 数据对话 — 询问有关您的锻炼、心率、活动环和健身趋势的问题。
...
- [callmac](https://github.com/openclaw/skills/tree/main/skills/jooey/callmac/SKILL.md) - 使用 /callmac 等命令从移动设备远程控制 Mac 语音。
...
- [icloud-findmy](https://github.com/openclaw/skills/tree/main/skills/liamnichols/icloud-findmy/SKILL.md) - 查询家庭设备的 Find My 位置和电池状态。
...
- [monolith](https://github.com/openclaw/skills/tree/main/skills/slaviquee/monolith/SKILL.md) - 用于 AI 代理的安全加密钱包。
...
- [omarchy](https://github.com/openclaw/skills/tree/main/skills/achals-iglu/omarchy/SKILL.md) - Omarchy 操作系统日常系统工作的防护准则：默认假设主机为 Omarchy，选择。
